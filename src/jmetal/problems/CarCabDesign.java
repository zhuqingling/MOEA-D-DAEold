...
//	    		- 9.98 * x[6] * x[7] + 22 * x[7] * x[8]) //g6
//    		 + (46.36 - 9.9 * x[1] - 12.9 * x[0] * x[7]
//    		    		+ 0.1107 * x[2] * x[9]) )/3; //g7
     
    f[5] =  Math.max(0.0, ( 28.98 + 3.818 * x[2] 
     		- 4.2 * x[0] * x[1] + 0.0207 * x[4] * x[9]
     	    		+ 6.63 * x[5] * x[8] - 7.77 * x[6] * x[7]
     	    		+ 0.32 * x[8] * x[9])/32-1.0);
    
    f[6] =  Math.max(0.0, (33.86 + 2.95 * x[2]
    		+ 0.1792 * x[9] - 5.057 * x[0] * x[1]
    		- 11 * x[1] * x[7] - 0.0215 * x[4] * x[9]
    		- 9.98 * x[6] * x[7] + 22 * x[7] * x[8])/32-1.0);
    
    f[7] =  Math.max(0.0, (46.36 - 9.9 * x[1] - 12.9 * x[0] * x[7]
    		+ 0.1107 * x[2] * x[9])/32-1.0);
    
    f[8] =  Math.max(0.0, (4.72 - 0.5 * x[3] - 0.19 * x[1] * x[2]
    		- 0.0122 * x[3] * x[9] + 0.009325 * x[5] * x[9]
    		+ 0.000191 * x[10] * x[10])/4.0);
    
    f[9] =  Math.max(0.0, (10.58 - 0.674 * x[0] * x[1] 
    		- 1.95  * x[1] * x[7]  + 0.02054  * x[2] * x[9] 
    		- 0.0198  * x[3] * x[9]  + 0.028  * x[5] * x[9])/9.9) ;
    
    f[10] =  Math.max(0.0, (16.45 - 0.489 * x[2] * x[6]
